...
def run_test_factorial():
    ...
    # Test 5:
    answer_from_formula = 5*4*3*2*1
    answer_from_my_code = factorial(5)
    print('Test 2 expected (from formula):', answer_from_formula)
    print('       actual (from my code): ', answer_from_my_code)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 0
    answer = count_cosines_from(0,1,2)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    ...
    # Test 4:
    expected = 0
    answer = count_cosines_from(8, 9, 0)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
...
def run_test_sum_unit_fractions_from():
    ...
    print('Test2  expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected =1.5
    answer = sum_unit_fractions_from(1, 2)
    print('Test3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
